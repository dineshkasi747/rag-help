      ...
      <div className="w-full max-w-md relative z-10 my-auto">
        <div data-slot="card" className="text-white flex flex-col gap-5 rounded-2xl md:rounded-3xl border border-white/15 p-6 sm:p-8 shadow-2xl backdrop-blur-xl bg-slate-900/70">
          <div data-slot="card-header" className="space-y-1.5 text-center">
            ...
            <h1 data-slot="card-title" className="text-2xl font-extrabold text-white tracking-tight">Welcome Back</h1>
            <p data-slot="card-description" className="text-white/50 text-xs sm:text-sm">Enter your credentials to access your account</p>
          </div>
          ...
          <div data-slot="card-content">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label htmlFor="email" className="text-xs font-semibold text-white/80 uppercase tracking-wider">Email Address</label>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="h-10 w-full rounded-xl border border-white/20 bg-white/10 pl-9 pr-10 text-sm text-white placeholder:text-white/30 outline-none focus:border-[#7a4aff] focus:bg-white/15 transition-all"
                  />
                  <button
                    type="button"
              ...
              <div className="flex justify-end pt-1">
                <Link href="#" className="text-xs text-[#9b6eff] hover:underline font-medium">
                  Forgot password?
                </Link>
              </div>
              ...
              <div className="text-center text-xs text-white/60 pt-3 border-t border-white/10">
                ...
                <Link href="/register" className="text-[#9b6eff] hover:underline font-bold">
                  Register
                </Link>
              </div>
            </form>
